...
<header class="page-header">
    <div class="d-flex align-items-center">
        <div class="mr-auto">
            <h1 class="separator">Detalhes da entrega</h1>
            <nav class="breadcrumb-wrapper" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html"><i class="la la-truck"></i></a></li>
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Entregas pendentes</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Entrega #<?php echo $_GET['id_entrega'] ?></li>
                </ol>
            </nav>
        </div>
...
<script>
    $(document).ready(function () {
        $.post('detalhes-entrega', {id_entrega: '<?php echo $_GET['id_entrega']; ?>'}, function (response) {
            if (is_json(response)) {
