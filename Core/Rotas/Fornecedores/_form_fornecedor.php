<?php 
    if(isset($_POST['editar_fornecedor']) && !empty($_POST['editar_fornecedor'])){
        ...
        $telefones = $o_telefone->select_telefone($id_fornecedor);
...
?>
    <div class="col-md-12">
        <div class="form-group m-form__group row">
         ...
         <div class="form-group m-form__group row">
            <div class="col-md-6">
                <label>CNPJ</label>
                <input name="cnpj" id="cnpj" type="text" class="form-control m-input" value="<?php if(isset($fornecedor['cnpj'])){ echo $fornecedor['cnpj']; }?>" placeholder="CNPJ">
            </div>
         </div>
    ...
    <?php if(isset($_POST['editar_fornecedor']) && !empty($_POST['editar_fornecedor'])){ ?>
