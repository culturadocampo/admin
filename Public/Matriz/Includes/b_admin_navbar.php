...
<nav class="top-toolbar navbar navbar-desktop flex-nowrap">
    <ul class="navbar-nav nav-left">
        ...
        <li class="nav-item">
            <a href="./"> <img src="Public/Images/logo_cc2.png" class="animated bounceIn m-l-15" style="width: auto; height: 60px;"></a>
        </li>
        <li class="nav-item nav-text dropdown dropdown-menu-md  animated bounceIn">
            <div class="btn-group dropdown m-t-15">
                <button type="button" class="btn btn-danger btn-flat btn-outline dropdown-toggle" data-toggle="dropdown">Administração</button>
                <div class="dropdown-menu menu-icons dropdown-menu-left">
                    <div class="form-group form-filter">
                        ...
                        <ul class="list-reset filter-list" data-scroll="minimal-dark">
                            <li><a class="dropdown-item" href="rotas"><i class="la la-map-signs"></i><span>Rotas/Permissão</span></a></li>
                            <li><a class="dropdown-item" href="#"><i class="la la-eye"></i><span>Permissões padrão</span></a></li>
                            <li>
                                <a class="dropdown-item" href="#" aria-expanded="false"><i class="la la-users"></i><span>Usuários cadastrados</span></a>
                            </li>
        ...
        <li class="nav-item nav-text dropdown dropdown-menu-md  animated bounceIn">
            <div class="btn-group dropdown m-t-15">
                <button type="button" class="btn btn-light btn-outline dropdown-toggle" data-toggle="dropdown">Produtor</button>
                <div class="dropdown-menu menu-icons dropdown-menu-left">
                    <div class="form-group form-filter">
                        <input type="text" placeholder="Filtrar..." class="form-control filter-input" data-search-trigger="open">
                        <i data-q-action="clear-filter" class="icon dripicons-cross clear-filter"></i>
                        <ul class="list-reset filter-list" data-scroll="minimal-dark">
                            <li><a class="dropdown-item" href="vendas-entregas"><i class="la la-map-marker"></i><span>Vendas/Entregas</span></a></li>
                            <li><a class="dropdown-item" href="cadastrar-produtor"><i class="la la-truck"></i><span>Quero vender!</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <?php if (Application::is_logged()) { ?>
            <li class="nav-item nav-text dropdown dropdown-menu-md">
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-menu-accout">
                    ...
                    <a class="dropdown-item" href="executa-logout"><i class="icon dripicons-lock-open"></i> Sair</a>
                </div>
            </li>
        <?php } else { ?>
