                                    ...
                                    <div class="card-body p-10">
                                        <ul class="nav metismenu">
                                            <li class="nav-dropdown">
                                                <a class="has-arrow" href="#" aria-expanded="false"><span>Cereais</span></a>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-lg-6 col-xl-4 col-xxl-3">
                                        <div class="card text-center p-20">
                                            ...
                                            <a href="javascript:void(0)">
                                                <img class="card-img-top m-t-30" src="Public/Images/apple.png" alt="">
                                            </a>
                                            <div class="card-body p-10">
                                    ...
                                    <div class="col-md-6 col-lg-6 col-xl-4 col-xxl-3">
                                        <div class="card text-center p-20">
                                            <ul class="actions top-left">
                                                <li><span class="badge badge-success">ORGÂNICO</span></li>
                                            </ul>
                                            <ul class="actions top-right">
                                                <li><a href="javascript:void(0)"><i class="icon dripicons-heart"></i></a></li>
                                            </ul>
                                            <img class="card-img-top m-t-30" src="Public/Images/morango.jpg" alt="">
                                            <div class="card-body p-10">
                                    ...
                                    <div class="col-md-6 col-lg-6 col-xl-4 col-xxl-3">
                                        <div class="card text-center p-20">
                                            ...
                                            <img class="card-img-top m-t-30" src="Public/Images/grape.png" alt="">
                                            <div class="card-body p-10">
                                    ...
                                    <div class="col-md-6 col-lg-6 col-xl-4 col-xxl-3">
                                        <div class="card text-center p-20">
                                            ...
                                            <a href="javascript:void(0)">
                                            <img class="card-img-top m-t-30" src="Public/Images/watermelon.png" alt="">
                                            </a>
                                            <div class="card-body p-10">
